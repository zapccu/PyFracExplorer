...
class ColorEditor:
	...
	def __init__(self, mainWindow):
		...
		self.colorPoints.pack_propagate(False)
		self.colorPoints.pack(side=LEFT, expand=False, fill=RIGHT, anchor='nw')
		...
		self.canvas = Canvas(self.colorPoints, width=600, height=50, bg='white', bd=0, highlightthickness=0, scrollregion=(0, 0, 600, 50))
